...
INSERT INTO `rental_product`
  (`id`, `name`, `owner_id`, `category`, `tag_text`, `price`, `deposit`, `rental_days`,
   ...
   `warehouse_value_text`, `status`, `description`)
VALUES
  (1001, '黑鹰 暗星 4格6体7负', 2, '高配冲分', '高段位,暗星刀皮,高KD',
   1580.00, 500.00, 30, 12000, 'QQ扫码', '4格', 6, 7,
   '黑鹰', 3.20, 2, '1:35', '江西省', '00:00-24:00',
   '暗星', 'AWM子弹117发', '蚀金玫瑰', '',
   '高价值仓库', 'AVAILABLE', '适合排位冲分和高强度作战，客服确认后交付。'),

  (1002, '坠星者 赤枭 9格7体7负', 2, '活动收藏', '稀有外观,活动资源,红皮',
   980.00, 300.00, 14, 3400, 'QQ账密', '9格', 7, 7,
   '坠星者', 2.50, 3, '1:32', '福建省', '09:00-23:00',
   '赤枭', 'AWM子弹81发', '天际线', '',
   '活动收藏资源', 'AVAILABLE', '包含活动收藏资源和常用作战配置，适合体验稀有外观。'),

  (1003, '青铜 新手体验 4格5体6负', 3, '低价体验', '新手试用,低价,基础装备',
   280.00, 100.00, 7, 800, '微信扫码', '4格', 5, 6,
   '青铜', 1.10, 1, '1:40', '四川省', '18:00-22:00',
   '黑海', '基础弹药', NULL, '',
   '入门资源', 'MAINTENANCE', '当前维护中，适合后续演示维护状态筛选。'),

  (1004, '北极星 龙牙 9格7体7负', 2, '高配冲分', '高段位,满仓库,龙牙刀皮',
  ...
  (1008, '青铜 入门体验 2格4体5负', 3, '低价体验', '入门体验,低价,新手',
   120.00, NULL, 3, 500, '微信扫码', '2格', 4, 5,
   '青铜', 0.80, 1, '1:20', '安徽省', '19:00-22:00',
   NULL, '入门武器资源', NULL, '',
   '入门仓库', 'AVAILABLE', '低价体验账号，适合游客浏览和快速租赁演示。'),

  (1009, '黄金 客服测试 4格6体6负', 3, '运营测试', '测试账号,订单演示,维护中',
