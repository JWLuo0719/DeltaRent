...
CREATE INDEX IF NOT EXISTS idx_sms_verify_code_phone_created
  ON sms_verify_code (phone, created_at);
CREATE INDEX IF NOT EXISTS idx_sms_verify_code_phone_type_created
  ON sms_verify_code (phone, type, created_at);
