...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/rentals", "/api/rentals/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/orders/**").hasAnyRole("ADMIN", "CS")
    ...
    @Bean
    public JwtAuthFilter jwtAuthFilter(SysUserMapper sysUserMapper) {
        return new JwtAuthFilter(sysUserMapper);
    }
}
